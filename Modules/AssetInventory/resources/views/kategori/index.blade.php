...
<div class="card shadow-sm">
    ...
    <div class="card-body">
        ...
        <p class="mb-2"><strong>Total Data :</strong> {{ $kategori->count() }}</p>
        ...
        <table class="table table-bordered table-sm">
            ...
            @forelse($kategori as $item)
                <tr>
                    ...
                    <td class="kode-tipis">{{ $item->kode_barang }}</td>
    ...
    <div class="modal-dialog modal-sm">
        <form action="{{ url('kategori-barang') }}" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <button type="button" class="btn btn-info btn-sm btn-block mb-3" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control form-control-sm"
                                  name="keterangan"
                                  rows="3"
                                  placeholder="Contoh: Barang elektronik kantor"></textarea>
                    </div>
                </div>
